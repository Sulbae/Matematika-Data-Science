...
Original file is located at
    https://colab.research.google.com/github/Sulbae/Matematika-Data-Science/blob/main/soal-1-distribusi-dan-algoritma-naive-bayes.ipynb
...
def viz_uniform_teoretis(lower_bound, upper_bound, num_samples):
  ...
  data = generate_rand_uniform(lower_bound=lower_bound, upper_bound=upper_bound, num_samples=num_samples)
...
def generate_gaussian(miu, sigma, num_samples):
  ...
  prob = generate_rand_uniform(lower_bound=0, upper_bound=1, num_samples=num_samples)

  # Petunjuk:
  # - Gunakan fungsi uniform_inverse_cdf untuk melakukan inverse CDF dari data acak yang dihasilkan pada fungsi sebelumnya.
  array = uniform_inverse_cdf(prob, miu, sigma)
  # AKHIRI KODE DI SINI
...
def generate_data_synthetic(breed, features, n_samples, params):
  ...
  for feature in features:
      ...
      feature_param = params[breed][feature]
      ...
      match feature:
              ...
              case "wingspan_cm" | "weight_g":
                df[feature] = generate_gaussian(feature_param.miu, feature_param.sigma, n_samples)
              ...
              case "sing_days":
                df[feature] = generate_binomial(feature_param.n_trials, feature_param.probability, n_samples)
              ...
              case "beak_head_ratio":
                df[feature] = generate_rand_uniform(feature_param.lower_bound, feature_param.upper_bound, n_samples)
  # AKHIRI KODE DI SINI
...
def training_params_estimation(df, features):
    ...
    for breed in df['breed']:
        ...
        df_bird_breed = df[df['breed'] == breed][features]
        ...
        probs_dict[breed] = len(df_bird_breed) / len(df)
